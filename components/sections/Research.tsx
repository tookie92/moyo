...
const Research = () => {
  return (
    <div className=' relative h-full py-40 flex-col flex bg-foundation z-10 px-5 md:px-20 lg:px-40  gap-10 md:gap-20 lg:gap-30 '>
        <div className='flex flex-col w-full gap-10 md:gap-20 lg:gap-30 relative'>
            ...
            <div className="flex w-full gap-10 md:gap-20 lg:gap-10">
                <MyCard title='7' content='Competitors Scans' className=' w-1/4 ' />
                <MyCard title='52' content='Survey Responses' className=' w-1/4 ' />
                <MyCard title='4' content='User Interviews' className=' w-1/4 ' />
                <MyCard title='1' content='Expert interview' className=' w-1/4 ' />
            </div>
        </div>
        {/* Research Insights*/}
        <div className='flex flex-col gap-10 mb-22'>
            ...
            <div className="flex flex-col mt-5">
             ...
             <Card className=' mt-5 border-1 border-black flex justify-center shadow-none items-center px-8 '>
                <CardContent className='flex h-full justify-center items-center w-full'>
                    
                    <div className='w-1/2 flex p-8 items-center justify-center'>
             ...
             <Card className='mt-5 border-1 border-black flex justify-center shadow-none items-center px-8'>
                <CardContent className='flex h-96 justify-center items-center w-full'> {/* h-96 ou une autre hauteur fixe */}
                    <div className='w-1/2 flex p-8 items-center flex-col gap-4 justify-center'>
                        <div className='h-64 w-64 items-center flex justify-center'>
                            <Pot/>
                        </div>
                        <div className='flex flex-col items-center justify-center gap-1'>
                            <p className='text-5xl font-sans'>Connection</p>
                            <p className='font-mono italic text-primary text-4xl'>matters</p>
                        </div>
                    </div>
                    
                    <Separator orientation='vertical' className='h-full bg-black'/>
                    
                    <div className='w-1/2 flex p-8 items-center flex-col gap-5 justify-center'>
                        <div className='h-64 w-64 items-center flex justify-center'>
                        ...
                        <div className='flex flex-col items-center justify-center gap-1'>
                            <p className='text-5xl font-sans'>Simplicity</p>
                            <p className='font-mono italic text-primary text-4xl'>is key</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
